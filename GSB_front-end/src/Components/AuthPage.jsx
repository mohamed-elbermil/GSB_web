    ...
    if (isLogin) {
      ...
      try {
          ...
          if (token) {
            ...
            if (decodedToken) {
              const userFromToken = {
                ...
                name:
                  decodedToken.name || decodedToken.nom || decodedToken.email,
              };
        ...
        if (error.name === "TypeError" && error.message.includes("fetch")) {
          setError(
            `Impossible de se connecter au serveur. Vérifiez que le serveur backend est démarré sur ${API_URL}`,
          );
        } else {
    ...
    <div className="auth-container">
      <div className="auth-left">
        <div className="auth-left-content">
          <img
            src="https://images.pexels.com/photos/3756681/pexels-photo-3756681.jpeg"
            alt="Person smiling"
